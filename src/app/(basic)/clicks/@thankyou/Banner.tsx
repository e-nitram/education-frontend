...
export default function Banner({ offer }: { offer: MAOOffer }) {
  return (
    <div className='col-span-2 flex h-[50svh] flex-col gap-4 rounded-lg bg-white px-4 py-3 text-primary shadow-outset'>
      <div className='flex flex-row gap-4'>
        <div className='relative h-20 w-36 items-start justify-center object-contain align-middle'>
          <Image src={offer.imageUrl} alt={offer.brandName} fill />
        </div>
        <h3 className='py-1.5 text-md font-semibold xl:text-md'>
          {offer.brandName}
        </h3>
      </div>
