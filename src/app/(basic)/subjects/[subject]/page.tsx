...
import SimilarSubjects from '@/app/(legal)/subjects/ad/[subject]/SimilarSubjects';
  ...
  return (
    <>
      <main className='bg-[#F5F5F5]'>
        ...
        {null != subject.area_of_interest && (
          <div className='flex min-h-[95vh] flex-col items-center justify-evenly gap-4 px-6 lg:px-24'>
            <SimilarSubjects area={subject.area_of_interest.id.toString()} />
          </div>
        )}
